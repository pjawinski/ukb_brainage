% =====================================================================================================
% === collect and stack brain age estimates for replication sample (cross-validation + singlemodel) ===
% =====================================================================================================
% /opt/matlab/bin/matlab -nodesktop -nodisplay -r "workingDir = pwd; threads = 100; spmPath = '/fast/software/matlab/spm12/'; rvmPath = '/fast/software/matlab/RVM/'; sbPath = '/fast/software/matlab/RVM/SB2_Release_200/'; run code/mri/brainageReplication.m"
fprintf('\n--- Collect & stack brain age estimates: replication sample ---\n')

% set working directory and load dataset
cd(workingDir)
fprintf('Loading dataset.\n')
load('results/mri/prepML.replication.mat');
...
ac3 = covs.table.t1_ac3;
TIV = meta.ratings(:,1);
for i = 1:12
    model = fitlm([sex age age2 ac1 ac2 ac3 TIV], brainage.data(:,i+12));
...
TIV = meta.ratings(:,1);
for i = 1:12
    model = fitlm([sex age age2 ac1 ac2 ac3 TIV], brainage_singlemodel.data(:,i+12));
...
save('results/mri/brainage.replication.mat', 'brainage', 'brainage_singlemodel', 'covs', 'gm_logical', 'meta', 'wm_logical')
...
writetable(brainage_table, 'results/mri/brainage.replication.txt', 'Delimiter', '\t', 'WriteRowNames', 0)
brainage_table = [covs.table array2table([meta.ratings, brainage_singlemodel.data],'VariableNames',colNames)];
writetable(brainage_table, 'results/mri/brainage.replication.singlemodel.txt', 'Delimiter', '\t', 'WriteRowNames', 0)

% quit matlab
fprintf('\n--- Completed: Collect & stack brain age estimates: replication sample ---\n')
exit
