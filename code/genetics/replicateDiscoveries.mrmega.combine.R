...
# set arguments
snplevelFile=args[1] # snplevelFile="results/combined/discovery.snplevel/snplevel.txt"
replicateFiles=args[2] # replicateFiles="results/gap_gm/replicate/mrmega.all/replicateDiscoveries.txt,results/gap_wm/replicate/mrmega.all/replicateDiscoveries.txt,results/gap_gwm/replicate/mrmega.all/replicateDiscoveries.txt"
outFile=args[3] # outFile="results/combined/replicateDiscoveries.all"
...
# calculate eta2 from MR-MEGA p-value
df$REPLIC_Z = qnorm(df$REPLIC_P/2, lower.tail = F)*sign(df$REPLIC_gwama_fe_beta)
df$REPLIC_ETA2 = df$REPLIC_Z^2/(df$REPLIC_Z^2+(df$REPLIC_N-2))
...
cols=c('DISCOV_LOCUS_COUNT','DISCOV_TRAITNAME','DISCOV_CYTOBAND','DISCOV_GWS',
  ...
  'NA','REPLIC_ID','REPLIC_CHR','REPLIC_BP','REPLIC_A1','REPLIC_A2','REPLIC_ISLEAD','REPLIC_LEAD_SNP_RSQ','REPLIC_LEAD_SNP_ALLELES',
  'REPLIC_A1_FREQ','REPLIC_gwama_re_beta','REPLIC_gwama_re_se','REPLIC_gwama_fe_beta','REPLIC_gwama_fe_se','REPLIC_chisq','REPLIC_ndf','REPLIC_P','REPLIC_Z','REPLIC_ETA2','REPLIC_N',
  'REPLIC_Effects','REPLIC_chisq_ancestry_het','REPLIC_ndf_ancestry_het','REPLIC_P.value_ancestry_het','REPLIC_chisq_residual_het','REPLIC_ndf_residual_het','REPLIC_P.value_residual_het','REPLIC_CONSIST_DIRECTION','REPLIC_CONSIST_REPLICATED',
...
status = '-- Completed: Creating table of MR-MEGA replication results for snp-level discoveries ---'; message(status); logInfo = sprintf('%s\n%s',logInfo,status)
