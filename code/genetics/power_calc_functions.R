# Note: This file has been downloaded from https://github.com/kaustubhad/gwas-power/blob/master/power_calc_functions.R
# Note: All credits go to GitHub user kaustubhad
