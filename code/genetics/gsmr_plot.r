# Note: This file has been downloaded from https://yanglab.westlake.edu.cn/software/gcta/res/gsmr_plot.r
# Note: All credits go to Jian Yang and colleagues.
# ************************************************** #
...
read_snp_effect = function(file_con) {
    ...
    while(1) {
        ...
        # print(length(strbuf)) # toggle comment by pjawinski
...
read_gsmr_data = function(gsmr_effect_file) {
    ...
    close(file_con) # added by pjawinski
...
gsmr_summary = function(gsmr_data) {
    ...
    # message("\n## GSMR result") # toggle comment by pjawinski
    m_bxy_rst = data.frame(gsmr_data$bxy_result)
    # print(m_bxy_rst) # toggle comment by pjawinski
}
